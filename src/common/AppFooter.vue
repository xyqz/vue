<template>
    ...
    <div class="foot-btn" >
      <ul>
        <router-link active-class="home2" class="home" tag="li" to="/home"><a href="javascript:;" ></a></router-link>
        <router-link active-class="write2" class="write" tag="li" to="/errorr"><a href="javascript:;"></a></router-link >
        <router-link active-class="my2" class="my" tag="li" to="/user"><a href="javascript:;"></a></router-link>       
      </ul>
    </div>
    </div>
</template>
...
.foot-btn ul .my{width:0.39rem;height:0.63rem; background:url(../assets/img/my.png) no-repeat 0 0;background-size:100%; margin-left:1.18rem; margin-top:0.07rem;z-index: 1000}
