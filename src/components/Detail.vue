...
<div class="content">
  <div class="header clear"><h2><img :src="'http://47.101.129.105'+detail.pic" alt="" style="width:340px;height:375px"/></h2><p></p></div>
  <div class="cont">
    <h3>{{detail.presentPrice}}</h3>
    <div class="time"><p>{{detail.time | data}} <span><img src="src/assets/img/zan.png" alt=""/></span></p></div>
    <div class="text-box">{{detail.desc}}</div>
  </div>
</div>
<div class="foot-btn">
  <ul>
...
export default {
 ...
 mounted(){
    ...
    this.$root.$data.blloading=false;
    this.$root.$data.blnav=false
    this.$root.$data.blfooter=false
